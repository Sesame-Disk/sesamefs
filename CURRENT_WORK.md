...
Real 3-DC evidence: RED without the fallback, GREEN with it, one-DC-down fails closed, and the disjoint-set all-cross-DC-hit cost methodology at N=1/10/100/1000 (N=1000 observed 1.67s-8.1s across runs on this local fixture -- a query-count formula, `⌈N/20⌉` waves, not a wall-clock bound). 15/15 mutations (M1-M15) produce the expected RED. Does not touch expired provenance, GC, G1-G5, or X1; `GC_ENABLED=false`.
