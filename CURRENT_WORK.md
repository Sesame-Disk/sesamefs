...
chain-pins the domain; mutation legs M1–M11 go
...
(`fmt.Sprintf`), a package-level FuncLit hides a DELETE IF, or an already
allowlisted unresolved Query (`UpdateLibrary`) becomes a HEAD LWT. Real 3-DC evidence
