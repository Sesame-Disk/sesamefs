...
| `ISSUE-PUBLISH-REPAIR-REACHABILITY-CONVERGENCE-01` | HIGH (P1) ✅ **Resolved 2026-09-12** — PRE-X1 / R31 convergence | Resumable SERIAL-anchored walk with durable cursor on the repair row; later HEAD movement does not restart work; UNKNOWN still retains; `pub:` is renewed while unresolved so liveness is not the original 35-day TTL | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-reachability-convergence-01) |
