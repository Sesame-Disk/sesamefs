...
| `ISSUE-PCD1-CERTIFIED-BASELINE-IMPLEMENTATION-01` | HIGH (P1) | Durable certified-through-HEAD witness, historical certification/backfill, and atomic HEAD+witness CAS are not implemented; implementation must use the per-dependency exact-P/incarnation -> durable library-liveness -> GC-authority revalidation handshake; required before PC-2 | [known issue](./KNOWN_ISSUES.md#issue-pcd1-certified-baseline-implementation-01) · [PC-D1](./PC-D1-INHERITED-DEPENDENCY-CONTINUITY.md) |
