...
| `ISSUE-PUBLISH-REPAIR-RENEWAL-AFTER-CLASSIFY-01` | HIGH (P1) — PRE-X1 / PRE-GC, not an R31-C1 blocker | Repair-owned `pub:` is renewed after the bounded classifier, so a visit whose remaining TTL is shorter than the walk can expire mid-classify. Not a regression versus `main`; does not close gap-free liveness. Discovery-after-expiry remains `ISSUE-PUBLISH-REPAIR-DISCOVERY-SCALE-01` | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-renewal-after-classify-01) |
