...
| `ISSUE-PUBLISH-REPAIR-RENEWAL-AFTER-CLASSIFY-01` | HIGH (P1) — PRE-X1 / PRE-GC, not an R31-C1 blocker | An unresolved visit can write/refresh per-row `pub:` after classify while pending; that can recreate an expired pin. The hazard is the zero-ref interval, not inability to renew. Discovery-after-expiry remains `ISSUE-PUBLISH-REPAIR-DISCOVERY-SCALE-01` | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-renewal-after-classify-01) |
