...
| `ISSUE-SYNC-PUTBLOCK-CROSS-DC-PROVENANCE-VISIBILITY-01` | HIGH (P1) | A PutBlock provenance row acknowledged in one DC may be invisible to an immediate LOCAL_QUORUM HEAD retry in another; local absence is not proof that PutBlock never occurred | [known issue](./KNOWN_ISSUES.md#issue-sync-putblock-cross-dc-provenance-visibility-01) - pre-GC/W2-R31 follow-up |
