...
| `ISSUE-SYNC-RECVFS-NOT-WRITE-ONCE-01` | HIGH (P1) ✅ Fixed by PR #208 (pending merge) | `RecvFS` verifies `fs_id`, completes matching placeholders, preserves metadata, rejects conflicting immutable payloads, and avoids per-object SERIAL/Paxos | [known issue](./KNOWN_ISSUES.md#issue-sync-recvfs-not-write-once-01) · PR #208 prerequisite; #206 remains blocked until merge and rebase |
