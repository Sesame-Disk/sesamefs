...
| `ISSUE-PUBLISH-REPAIR-REACHABILITY-CONVERGENCE-01` | HIGH (P1) ✅ **Resolved 2026-09-12** — PRE-X1 / R31 convergence | Resumable SERIAL-anchored walk with durable next-unread cursor; later HEAD movement and 30s/EQ interruption do not restart work; missing repair row is a no-op; UNKNOWN still retains; repair-owned `pub:<commitID>` is renewed while unresolved | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-reachability-convergence-01) |
