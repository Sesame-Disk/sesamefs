...
| `ISSUE-PUBLISH-REPAIR-DISCOVERY-SCALE-01` | MEDIUM (P2) | UNKNOWN repair rows are rediscovered by a full repair-bucket scan every minute; durable discovery needs a separately audited bounded design | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-discovery-scale-01) - PR #206 keeps this follow-up open |
