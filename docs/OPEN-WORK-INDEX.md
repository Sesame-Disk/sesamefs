...
| `ISSUE-PUBLISH-REPAIR-DEAD-ROW-RETENTION-01` | LOW (P3) — OPEN — PRE-GC over-retention | A repair row left by a failed clear (after a proven loser's cleanup, or after a successful reconciliation) is UNKNOWN on every visit, re-pins its staged blocks for 35 d each time and is never settled: the protocol has no durable negative cleanup authority. No under-retention. Observed while adding repair-worker observability | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-dead-row-retention-01) |
