...
| `ISSUE-PUBLISH-REPAIR-RENEWAL-AFTER-CLASSIFY-01` | HIGH (P1) - Resolved 2026-09-14; bounded 2026-09-16 | Pre-classify renewal is durable and producer-token keyed: `pub:<repo:commit:fsID>:<producer_token>` is written before the bounded walk, every pin and fence uses the producer lease timestamp, and the sweep retains pending witnesses without destructive compaction. Migration 027 reserves at most 32 new producer witnesses per live generation with a generation-bound SERIAL CAS; exhaustion fails closed before token/intent creation. Unit M1-M41 (73/73 expected RED), including M39/M40 pending-partial retention and M41 budget removal, plus real Cassandra renewal/rediscovery and 3-DC stale-lease and producer-isolation evidence cover the safety contract. Discovery-after-expiry and sequential fan-out expiry remain separate R31 follow-ups | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-renewal-after-classify-01) |
