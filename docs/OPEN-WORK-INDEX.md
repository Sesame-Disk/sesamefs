...
| `ISSUE-GC-HARD-DELETE-LEASE-NONFENCING-01` | HIGH (P1) — PRE-GC lifecycle; not a #232 merge blocker | A lease owner can pause after renewal, lose ownership to a restore/delete takeover, then resume its unconditional final batch and delete the restored library or recreate partial canonical cells | [known issue](./KNOWN_ISSUES.md#issue-gc-hard-delete-lease-nonfencing-01) |
