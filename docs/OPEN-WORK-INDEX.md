...
| `ISSUE-PUBLISH-REPAIR-REACHABILITY-CONVERGENCE-01` | HIGH (P1) — PRE-X1 / R31 convergence | The 1024-node walk from a moving HEAD can leave a repair `UNKNOWN` forever (active library + multi-hour retry window) while `pub:` still expires at 35 d; retain stays correct, convergence does not; not a #213 regression | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-reachability-convergence-01) |
