...
| `ISSUE-PUBLISH-REPAIR-REACHABILITY-01` | ✅ CLOSED 2026-09-09 (shared repair classifier) | Tri-state classification now uses a 30s/1024-node cold-path bound, `SERIAL` HEAD and `EACH_QUORUM` commit reads; inconclusive evidence never authorizes cleanup. No durable negative producer was invented | [known issue](./KNOWN_ISSUES.md#issue-publish-repair-reachability-01) · broader [R31](./GC-X1-PHYSICAL-LIFE-HANDOFF-PLAN.md#16-r31-remains-a-blocker-open) remains open |
