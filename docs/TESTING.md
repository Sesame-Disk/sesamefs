...
`scripts/library-head-serial-domain-mutation-validation.sh` (M1–M24 RED:
...
turned into `DELETE FROM libraries ... IF EXISTS`, an embedded migration that competes for HEAD, a
